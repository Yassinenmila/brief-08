            ...
            <?php foreach($books as $b): ?>
                <div class="bg-white shadow-md rounded-lg p-5 flex flex-col justify-between">
                    <div>
                        ...
                        <p class="text-gray-700 mb-1"><strong>Auteur :</strong> <?= htmlspecialchars($b['autor_name']) ?></p>
                        <p class="text-gray-700 mb-3"><strong>Date :</strong> <?= htmlspecialchars($b['date_publication']) ?></p>
