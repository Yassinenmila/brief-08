<form method="POST" class="bg-white p-6 rounded-lg shadow-md w-full max-w-lg">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="author_name" placeholder="Nom de l'auteur" value="<?= $book['autor_name'] ?>" required class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
        <div class="mb-4">
            <label class="block text-gray-700 mb-1">Date de publication</label>
            <input type="date" name="date_pub" value="<?= $book['date_publication'] ?>" required class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
        </div>
        <div class="mb-6">
